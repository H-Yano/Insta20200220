...
void ofApp::update() {
	...
	for (auto z = -70; z <= 70; z += 20) {

		for (auto radius = 300; radius <= 440; radius += 20) {

			auto noise_seed = ofRandom(1000);
			auto noise_value = ofNoise(noise_seed, ofGetFrameNum() * 0.008);
			auto len = noise_value > 0.9 ? 360 : ofMap(noise_value, 0, 0.9, 0, 360);
			this->setRingToMesh(this->face, this->frame, glm::vec3(0, 0, z), 0, len, radius, 20, 20);
		}
	}
}
